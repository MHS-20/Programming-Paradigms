...
public interface ConferenceReviewing {
    ...
    /**
     * @param article
     * @param scores  loads a review for the specified article, with complete scores as a map
     */
     ...
     * @param significance
     * @param confidence
     * @param fin          loads a review for the specified article, with the 4 explicit scores
     */
